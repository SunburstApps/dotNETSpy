    ...
    public partial class ProgressDialog : Component
    {
        ...
        public ProgressDialog(IContainer container)
        {
            ...
            if (!NativeMethods.IsWindowsVistaOrLater)
                Animation = AnimationResource.GetShellAnimation(dotNETSpy.Controls.ShellAnimation.FlyingPapers);
        }
        ...
        /// </summary>
        /// <value>
        /// One of the values of <see cref="dotNETSpy.Controls.ProgressBarStyle"/>. 
        /// The default value is <see cref="dotNETSpy.Controls.ProgressBarStyle.ProgressBar"/>.
        /// </value>
        /// <remarks>
        /// <note>
        ...
        ///   progress bar will be hidden completely if this property is <see cref="dotNETSpy.Controls.ProgressBarStyle.MarqueeProgressBar"/>.
        /// </note>
        /// <para>
        ///   When this property is set to <see cref="dotNETSpy.Controls.ProgressBarStyle.ProgressBar" />, use the <see cref="ReportProgress(int)"/> method to set
        ///   the value of the progress bar. When this property is set to <see cref="dotNETSpy.Controls.ProgressBarStyle.MarqueeProgressBar"/>
        ...
        /// </para>
        /// <para>
        ///   This method has no effect is <see cref="ProgressBarStyle"/> is <see cref="dotNETSpy.Controls.ProgressBarStyle.MarqueeProgressBar"/>
        ///   or <see cref="dotNETSpy.Controls.ProgressBarStyle.None"/>.
        /// </para>
        /// </remarks>
        ...
        private void RunProgressDialog(IntPtr owner, object argument)
        {
            ...
            Interop.ProgressDialogFlags flags = dotNETSpy.Controls.Interop.ProgressDialogFlags.Normal;
            if (owner != IntPtr.Zero)
                flags |= dotNETSpy.Controls.Interop.ProgressDialogFlags.Modal;
            switch (ProgressBarStyle)
            {
                case ProgressBarStyle.None:
                    flags |= dotNETSpy.Controls.Interop.ProgressDialogFlags.NoProgressBar;
                    break;
                case ProgressBarStyle.MarqueeProgressBar:
                    if (NativeMethods.IsWindowsVistaOrLater)
                        flags |= dotNETSpy.Controls.Interop.ProgressDialogFlags.MarqueeProgress;
                    else
                        flags |= dotNETSpy.Controls.Interop.ProgressDialogFlags.NoProgressBar; // Older than Vista doesn't support marquee.
                    break;
            }
            if (ShowTimeRemaining)
                flags |= dotNETSpy.Controls.Interop.ProgressDialogFlags.AutoTime;
            if (!ShowCancelButton)
                flags |= dotNETSpy.Controls.Interop.ProgressDialogFlags.NoCancel;
            if (!MinimizeBox)
                flags |= dotNETSpy.Controls.Interop.ProgressDialogFlags.NoMinimize;
