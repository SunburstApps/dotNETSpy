...
//		}
		...
		/// <summary>
		/// The current Token. <seealso cref="ICSharpCode.NRefactory.VisualBasic.Parser.Token"/>
		/// </summary>
		public Token Token {
			get {
//				Console.WriteLine("Call to Token");
		...
		/// <summary>
		/// The next Token (The <see cref="Token"/> after <see cref="NextToken"/> call) . <seealso cref="ICSharpCode.NRefactory.VisualBasic.Parser.Token"/>
		/// </summary>
